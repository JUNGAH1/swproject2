...
#define _DUTY_NEU 2460 // servo neutral position (90 degree)
#define _DUTY_MAX 4420 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if (dist_raw <= _TARGET_LOW) {
    ...
    myservo.writeMicroseconds(_DUTY_NEU);
  } else if (_TARGET_HIGH <= dist_raw) {
    myservo.writeMicroseconds(_DUTY_MAX);
    
  }
  
  int servoAngle = map(dist_raw, _TARGET_LOW, _TARGET_HIGH, 0, 180);
